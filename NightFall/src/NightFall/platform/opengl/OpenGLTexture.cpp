...
nfe::OpenGLTexture2D::OpenGLTexture2D(const std::string & path)
{
...
nfe::OpenGLTexture2D::~OpenGLTexture2D()
{
	glDeleteTextures(1, &_id);
}

uint32_t nfe::OpenGLTexture2D::getWidth() const
{
	return _width;
}

uint32_t nfe::OpenGLTexture2D::getHeight() const
{
	return _height;
}

void nfe::OpenGLTexture2D::bind(uint32_t slot) const
{
